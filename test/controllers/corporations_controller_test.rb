...
class CorporationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create corporation" do
    assert_difference('Corporation.count') do
      post corporations_url, params: { corporation: { name: @corporation.name, name_kana: @corporation.name_kana } }
    end
  ...
  test "should update corporation" do
    patch corporation_url(@corporation), params: { corporation: { name: @corporation.name, name_kana: @corporation.name_kana } }
